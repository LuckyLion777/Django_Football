...
from theme.portfolio.models import Portfolio
...
class UserModel(models.Model):
    ...
    # From https://planetarynames.wr.usgs.gov/Abbreviations#Africa
    AFRICAN_COUNTRY_CHOICES = (
            ('--', 'Unknown'),
            ('AL', 'Algeria'),
            ('AN', 'Angola'),
            ('BA', 'Bantu'),
            ...
            ('RS', 'Republic of Sao Tome and Principe'),
            ('SY', 'Republic of Seychelles'),
            ('RC', 'Repulic of the Congo (Congo-Brazzaville)'),
            ('RI', 'Reunion Island'),
            ('RW', 'Rwanda'),
            ('SE', 'Semitic'),
            ('SN', 'Senegal'),
    ...
    country = models.CharField(
            max_length=2,
            choices=AFRICAN_COUNTRY_CHOICES,
            default='--'
            )
    ...
    avatar = models.ImageField(
            upload_to='avatars/',
            default='avatars/none/default_avatar.jpg',
            blank=True
            )
